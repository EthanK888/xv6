...
main(void)
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
      ...
      17:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
      1e:	00 
      1f:	90                   	nop
    if(fd >= 3){
...
00000180 <runcmd>:
{
  ...
  switch(cmd->type){
     ...
     19d:	3e ff 24 85 18 13 00 	notrack jmp *0x1318(,%eax,4)
     1a4:	00 
    if(pipe(p) < 0)
  ...
  if(pid == -1)
    ...
    close(p[0]);
     ...
     1eb:	ff 75 f0             	push   -0x10(%ebp)
     1ee:	e8 c8 0b 00 00       	call   dbb <close>
    close(p[1]);
     1f3:	58                   	pop    %eax
     1f4:	ff 75 f4             	push   -0xc(%ebp)
  ...
  if(pid == -1)
    ...
    runcmd(lcmd->right);
     ...
     26d:	ff 73 08             	push   0x8(%ebx)
     270:	e8 0b ff ff ff       	call   180 <runcmd>
    close(rcmd->fd);
     275:	83 ec 0c             	sub    $0xc,%esp
     278:	ff 73 14             	push   0x14(%ebx)
     27b:	e8 3b 0b 00 00       	call   dbb <close>
    if(open(rcmd->file, rcmd->mode) < 0){
     280:	58                   	pop    %eax
     281:	5a                   	pop    %edx
     282:	ff 73 10             	push   0x10(%ebx)
     285:	ff 73 08             	push   0x8(%ebx)
    ...
    panic("runcmd");
     ...
     2dc:	e8 2a 0b 00 00       	call   e0b <dup>
      close(p[0]);
     2e1:	58                   	pop    %eax
     2e2:	ff 75 f0             	push   -0x10(%ebp)
     2e5:	e8 d1 0a 00 00       	call   dbb <close>
      close(p[1]);
     2ea:	58                   	pop    %eax
     2eb:	ff 75 f4             	push   -0xc(%ebp)
     2ee:	e8 c8 0a 00 00       	call   dbb <close>
      runcmd(pcmd->left);
     2f3:	5a                   	pop    %edx
     2f4:	ff 73 04             	push   0x4(%ebx)
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
    ...
    case '+':  // >>
     ...
     6fb:	ff 75 e4             	push   -0x1c(%ebp)
     6fe:	ff 75 e0             	push   -0x20(%ebp)
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     a1d:	3e ff 24 85 30 13 00 	notrack jmp *0x1330(,%eax,4)
     a24:	00 
  ...
  case LIST:
    ...
    nulterminate(lcmd->left);
     ...
     a2b:	ff 73 04             	push   0x4(%ebx)
     a2e:	e8 cd ff ff ff       	call   a00 <nulterminate>
    nulterminate(lcmd->right);
     a33:	58                   	pop    %eax
     a34:	ff 73 08             	push   0x8(%ebx)
     ...
     b35:	31 c0                	xor    %eax,%eax
{
  ...
  return os;
     ...
     b51:	5d                   	pop    %ebp
     b52:	c3                   	ret
     b53:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
     b5a:	00 
...
strlen(const char *s)
{
  ...
  for(n = 0; s[n]; n++)
     ...
     be5:	c3                   	ret
     be6:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
     bed:	00 
     ...
     e4c:	89 d1                	mov    %edx,%ecx
{
  ...
  neg = 0;
     ...
     ee1:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
     ee8:	00 
    ...
    10e6:	73 10                	jae    10f8 <free+0x38>
{
  ...
  freep = p;
    ...
    1119:	5d                   	pop    %ebp
    111a:	c3                   	ret
    111b:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
    bp->s.size += p->s.ptr->s.size;
...
malloc(uint nbytes)
{
  ...
  return freep;
    ...
    1215:	5d                   	pop    %ebp
    1216:	c3                   	ret
    1217:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
    121e:	00 
    121f:	90                   	nop
    base.s.ptr = freep = prevp = &base;
