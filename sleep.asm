...
int main(int argc, char *argv[]) {
  ...
  26:	e8 05 04 00 00       	call   430 <printf>
    	exit();
  2b:	e8 a3 02 00 00       	call   2d3 <exit>
 	 }

	int NoOfTicks;
	NoOfTicks = atoi(argv[1]); //convert argument from string to int
  30:	83 ec 0c             	sub    $0xc,%esp
  33:	ff 70 04             	push   0x4(%eax)
  36:	e8 25 02 00 00       	call   260 <atoi>
	
	if (NoOfTicks > 0){
  3b:	83 c4 10             	add    $0x10,%esp
  3e:	85 c0                	test   %eax,%eax
  40:	7e 0e                	jle    50 <main+0x50>
		sleep(NoOfTicks); //calling sleep system call
  42:	83 ec 0c             	sub    $0xc,%esp
  45:	50                   	push   %eax
  46:	e8 18 03 00 00       	call   363 <sleep>
		exit();
