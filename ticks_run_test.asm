...
_ticks_run_test:     file format elf32-i386
...
int main(void) {
  ...
  17:	e8 57 03 00 00       	call   373 <getpid>
    printf(1, "PID: %d\n", pid);
  ...
  31:	e8 5d 03 00 00       	call   393 <ticks_run>
  ...
  3a:	89 c6                	mov    %eax,%esi
    printf(1, "before sleep ticks: %d\n", before_ticks);
  3c:	68 c1 07 00 00       	push   $0x7c1
  41:	6a 01                	push   $0x1
  43:	e8 08 04 00 00       	call   450 <printf>

    sleep(5);
  48:	c7 04 24 05 00 00 00 	movl   $0x5,(%esp)
  4f:	e8 2f 03 00 00       	call   383 <sleep>

    int after_ticks = ticks_run(pid); //after sleeping
  54:	89 1c 24             	mov    %ebx,(%esp)
  57:	e8 37 03 00 00       	call   393 <ticks_run>
  ...
  60:	89 c3                	mov    %eax,%ebx
    printf(1, "after sleep ticks: %d\n", after_ticks);
  62:	68 d9 07 00 00       	push   $0x7d9

    //difference
    int ticks_used = after_ticks - before_ticks;
  67:	29 f3                	sub    %esi,%ebx
    printf(1, "after sleep ticks: %d\n", after_ticks);
  69:	6a 01                	push   $0x1
  ...
  73:	53                   	push   %ebx
  74:	68 f0 07 00 00       	push   $0x7f0
  79:	6a 01                	push   $0x1
  7b:	e8 d0 03 00 00       	call   450 <printf>

    exit();
  80:	e8 6e 02 00 00       	call   2f3 <exit>
  85:	66 90                	xchg   %ax,%ax
  87:	66 90                	xchg   %ax,%ax
  89:	66 90                	xchg   %ax,%ax
  8b:	66 90                	xchg   %ax,%ax
  ...
  95:	31 c0                	xor    %eax,%eax
{
  ...
  b1:	5d                   	pop    %ebp
  b2:	c3                   	ret
  b3:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
  ba:	00 
...
printf(int fd, const char *fmt, ...)
{
 ...
 5d4:	eb 1a                	jmp    5f0 <printf+0x1a0>
          s = "(null)";
 5d6:	bb 03 08 00 00       	mov    $0x803,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 625:	a1 bc 0a 00 00       	mov    0xabc,%eax
{
 ...
 646:	73 10                	jae    658 <free+0x38>
{
 ...
 671:	5b                   	pop    %ebx
  freep = p;
 672:	a3 bc 0a 00 00       	mov    %eax,0xabc
}
 677:	5e                   	pop    %esi
 678:	5f                   	pop    %edi
 679:	5d                   	pop    %ebp
 ...
 697:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 69a:	a3 bc 0a 00 00       	mov    %eax,0xabc
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6bd:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6c0:	8b 3d bc 0a 00 00    	mov    0xabc,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 709:	8b 3d bc 0a 00 00    	mov    0xabc,%edi
 ...
 732:	e8 e9 fe ff ff       	call   620 <free>
  return freep;
 737:	a1 bc 0a 00 00       	mov    0xabc,%eax
 ...
 764:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 767:	a3 bc 0a 00 00       	mov    %eax,0xabc
}
 ...
 77f:	90                   	nop
    base.s.ptr = freep = prevp = &base;
 780:	c7 05 bc 0a 00 00 c0 	movl   $0xac0,0xabc
 787:	0a 00 00 
    base.s.size = 0;
 78a:	bf c0 0a 00 00       	mov    $0xac0,%edi
    base.s.ptr = freep = prevp = &base;
 78f:	c7 05 c0 0a 00 00 c0 	movl   $0xac0,0xac0
 796:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
